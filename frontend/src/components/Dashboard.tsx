              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-gray-500 capitalize">
                    {authUser?.role === 'viewer' && authUser?.email === 'viewer@guest.com' 
                      ? 'Acceso Público' 
          ...
          <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-sm text-blue-800">
                <strong>
                  {authUser?.email === 'viewer@guest.com' 
                    ? 'Acceso Público:' 
                    : 'Modo Solo Lectura:'
                  }
                </strong> Puedes ver el resumen, análisis y calendario. 
                Para editar contenido o gestionar usuarios, contacta a tu administrador.
              </p>
            </div>
          </div>
        )}
